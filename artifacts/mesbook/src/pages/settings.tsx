...
import { MessageSquare, LogOut, Check, Moon, Sun, Users } from 'lucide-react';
    ...
    <div className="flex h-screen flex-col bg-white dark:bg-black transition-colors duration-300">
      ...
      <main className="flex-1 overflow-y-auto px-6">
        <div className="flex justify-center my-6">
          <div className="w-28 h-28 rounded-full bg-gray-100 dark:bg-zinc-900 flex items-center justify-center text-black dark:text-white text-4xl font-semibold mb-2 overflow-hidden border-4 border-white dark:border-black shadow-sm">
        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div>
            <label className="block text-[10px] font-bold text-gray-400 dark:text-zinc-500 uppercase mb-1.5 ml-1 tracking-wider">Ссылка на аватарку</label>
            <input
              type="text"
              value={avatarUrl}
